defmodule ChirpWeb.PostLiveTest do
  ...
  @create_attrs %{likes_count: 42, reposts_counter: 42, username: "some username"}
  @update_attrs %{likes_count: 43, reposts_counter: 43, username: "some updated username"}
  @invalid_attrs %{likes_count: nil, reposts_counter: nil, username: nil}
